...
parser.add_argument("--fuzz_tsc", help=f"Enable TSC Fuzzing", default=False)
parser.add_argument("--fuzz_tsc_extent", help=f"Extent of TSC Fuzzing", default=100)
parser.add_argument("--fuzz_tsc_rand", help=f"Randomize the extent of TSC Fuzzing", default=False)
parser.add_argument("--naive", help="Enable Naive Approach", default=False)
parser.add_argument("--taint", help="Enable Taint Approach", default=False)
...
processor.cores[0].core.isa[0].fuzz_TSC_extent = options.fuzz_tsc_extent
processor.cores[0].core.isa[0].fuzz_TSC_rand = options.fuzz_tsc_rand
